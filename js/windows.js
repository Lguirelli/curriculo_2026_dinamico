...
function portfolioFolderItemIconMarkup(){
  return `
    <span class="folder-icon folder-icon-inline" aria-hidden="true">
      <span class="folder-asset" aria-hidden="true">
        <span class="folder-asset-back"></span>
        <span class="folder-asset-front"></span>
      </span>
    </span>
  `;
}
...
function openHtmlApp(item){
  ...
  const html = createBrowserFrameHTML(item.label, url);
